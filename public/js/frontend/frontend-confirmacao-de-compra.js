jQuery(function($) {
  ...
  $(".gallery").each(function() {
    ...
    $(this).magnificPopup({
      ...
      gallery: {
        enabled: true,
        tPrev: "Anterior (Botão esquerdo)", // title for left button
        tNext: "Próximo (Botão direito)", // title for right button
...
//# sourceMappingURL=frontend-confirmacao-de-compra.js.map
