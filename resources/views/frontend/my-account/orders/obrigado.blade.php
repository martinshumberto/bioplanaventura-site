					...
					<div class="row">
						<div class="col-lg-12 col-md-12 col-12">
							<div class="page-hero-content">
								<h2 class="page-hero-title"><b>Obrigado {!! $dadosuser->name !!}</b></h2>
								<p class="page-hero-subtitle">Seu pedido foi recebido com sucesso.</p>
							</div>
							...
							<div class="container">
								<iframe src="{!! URL::to($dadospagamento->data->pdf->charge) !!}" width="100%" height="600"></iframe>
							</div>
