                            ...
                            <div class="entry-content">
                                ...
                                <table class="table-responsive">
                                    ...
                                    <tbody>
                                        ...
                                        @if (!session('carrinho'))
                                        <tr><td colspan="6"> VOCÊ AINDA NÃO REALIZAOU NENHUMA TRANSAÇÃO </td></tr>
                                        @else
                                        <tr>
                                            <td>{{ Eventos::where('eventos_id', '=', session('carrinho')['eventos_id'])->first()->title }} </td>
                                            <td>{{ session('carrinho')['quantidade_inteira'] }}</td>
                                            <td>{{ number_format(Eventos::where('eventos_id', '=', session('carrinho')['eventos_id'])->first()->ingressointeiro, 2) }}</td>
