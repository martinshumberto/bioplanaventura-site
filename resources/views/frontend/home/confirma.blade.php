    ...
    <div class="row">
      <div class="col-12">
        <div class="page-hero-content">
          <h1 class="page-hero-title">Cadastro Efetuado</h1>
          <p class="page-hero-subtitle">Confirmação de Cadastro</p>
        </div>
      </div>
    </div>
  </div>
...
<main class="main">
  <div class="container">
    <div class="row">
      ...
      <article class="entry">
          <h3>Olá {!! $nome !!}</h3>
       Enviamos um e-mail para o endereço {!! $email !!}, com um link para confirmar seu cadastro.
      </article>
      </div>
