...
use App\Model\Fotos;
@endphp
@section('title', 'Bioplan Aventura - Seja bem vindo')
@section('content')
          ...
          <div class="row">
            <div class="col-12">
              <div class="page-hero-content">
                ...
                <a href="{!! $item->action !!}" class="btn">{!! $item -> button !!}</a>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="row row-items">
        ...
        <div class="col-lg-3 col-sm-6 col-12">
          <article class="item item-entry">
            <div class="item-thumb item-thumb-blog">
            ...
            <div class="item-content">
              ...
              <h3 class="item-title item-title-blog">
