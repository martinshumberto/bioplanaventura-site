			...
			<article class="comment-body">
				<footer class="comment-meta">
					<div class="comment-author vcard">
						<img alt="" src="img/avatar03.jpg" class="avatar avatar-64 photo" height="64" width="64">
					...
					<div class="comment-metadata">
						...
						@php 
							switch ($comentario->star_rating) {
							   case 1:
							      echo "<span class='star-rating star-rating-1'><span class='star-rating-inner'></span></span>";
							      break;
							   case 2:
							      echo "<span class='star-rating star-rating-2'><span class='star-rating-inner'></span></span>";
							      break;
							   case 3:
							      echo "<span class='star-rating star-rating-3'><span class='star-rating-inner'></span></span>";
							      break;
							   case 4:
							      echo "<span class='star-rating star-rating-4'><span class='star-rating-inner'></span></span>";
							      break;
							   case 5:
							      echo "<span class='star-rating star-rating-5'><span class='star-rating-inner'></span></span>";
							      break;
							   default :
							   	echo "<span class='star-rating star-rating-0'><span class='star-rating-inner'></span></span>";
							   	break;
							}
						@endphp
						<time datetime="{{ date('Y-m-d H:i:s', strtotime($comentario->created_at)) }}">
	...
	<div id="respond" class="comment-respond">
		...
		<p class="comment-form-star-rating">
			...
			<span class="star-rating-input">
				<input type="radio" class="star-rating-input" value="5" name="star_rating" id="star-rating-5" required>
