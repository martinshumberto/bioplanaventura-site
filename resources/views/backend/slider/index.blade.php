        ...
        <div class="main-layout full-width">
            <div class="content-box mt-20 fadeInUp animated">
                <div class="row no-gutters p-20 pb-5 align-items-center">
                    <div class="col-6 box-title">Slider</div>
                    <div class="col-3 box-title text-right">
                        <a href="{!!route('backend-slider-create')!!}" class="btn fw-sm-120 btn-success">
                            <i class="icon mdi mdi-plus"></i> Novo
                        </a>
                    </div>
                    <div class="col-3 box-title text-right pl-20">
                    {{ html()->form('GET', route('backend-slider'))->open() }}
                ...
                <div class="px-20 pb-20">
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <th scope="row">{!!$item->slider_id!!}</th>
                                <td>{!!$item->title!!}</td>
                                ...
                                <td>
                                    ...
                                    <a href="{!!route('backend-slider-destroy', [$item->slider_id])!!}">
                                        <i class="icon mdi mdi-trash-can"></i>
                                    </a>
                                    <a href="{!!route('backend-slider-show', [$item->slider_id])!!}">
