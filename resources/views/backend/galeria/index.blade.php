        ...
        <div class="main-layout full-width">
            <div class="content-box mt-20 fadeInUp animated">
                <div class="row no-gutters p-20 pb-5 align-items-center">
                    <div class="col-6 box-title">Galerias</div>
                    <div class="col-3 box-title text-right">
                        <a href="{!!route('backend-galeria-create')!!}" class="btn fw-sm-120 btn-success">
                            <i class="icon mdi mdi-plus"></i> Nova
                        </a>
                    </div>
                    <div class="col-3 box-title text-right pl-20">
                    {{ html()->form('GET', route('backend-galeria'))->open() }}
                ...
                <div class="px-20 pb-20">
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <th scope="row">{!!$item->gallery_id!!}</th>
                                <td>{!!$item->title!!}</td>
                                ...
                                <td>
                                    ...
                                    <a href="{!!route('backend-galeria-destroy', [$item->gallery_id])!!}">
                                        <i class="icon mdi mdi-trash-can"></i>
                                    </a>
                                    <a href="{!!route('backend-galeria-show', [$item->gallery_id])!!}">
